//This file defines a ChatBubble component for a chat application that displays messages 
//with support for different content types 
//(text, images, videos), handles user interactions, and adjusts its appearance based on the message sender
