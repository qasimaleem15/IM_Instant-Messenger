import { createCipheriv } from "crypto";//Imports the createCipheriv function from Node.js's crypto module, used for AES encryption.

enum ErrorCode { //Define various constants that represent specific error conditions, privileges keys, and privilege values.
	success = 0, // "success"
